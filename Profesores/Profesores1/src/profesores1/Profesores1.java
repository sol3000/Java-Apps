...
public class Profesores1 {
	...
	//Creamos el fichero de texto fichero para almacenar datos
            File fichero = new File( "..\\profesores1.txt");
		...
		Profesor.pagoPorHoraExtra=pagoPorHoraExtra;
                    ...
                    try
                        ...
                        //Si el fichero ya existe envía el fichero y recibe una lista
                         lista=Funciones.obtenerArrayListDeArchivo(fichero);
		...
		try {
			...
			break;			
                        ...
                        case 7:
                          ...
                          //LLamamos al método  para pasar la nueva lista y grabarla en el fichero profesores1.txt
                            Funciones.almacenarColPuntosEnArchivo(lista, fichero);
