 ...
 * @author Soledad Soto
 */
public class Profesores2 {
    
    public static void main(String[] args) throws IOException, ClassNotFoundException {
            
                //Creamos el fichero .dat para almacenar los objetos de la lista
                File fichero =new File("..\\profesores2.dat");
		Scanner sc= new Scanner(System.in);
		
		//Variable para salir del menú de selección
                boolean salir = false;
                int codigo;
                int mes;
		...
		Profesor.pagoPorHoraExtra=pagoPorHoraExtra;
                    ...
                    try
                        {   
                        //Si el fichero ya existe envía el fichero y recibe una lista
                         lista=Funciones.obtenerObjetosDeArchivo(fichero);
		...
		try {
			...
			break;			
                        ...
                        case 7:
                          ...
                          //LLamamos al método  para pasar la nueva lista y grabarla en el fichero profesores2.dat
                            Funciones.almacenarObjetosEnArchivo(lista,fichero);
